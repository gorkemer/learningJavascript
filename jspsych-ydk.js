...
jsPsych.plugins["ydk"] = (function() {
	...
	plugin.trial = function(display_element, trial) {
		...
		*/
		...
		var canvasHeight = canvas.height = window.innerHeight-350;
		...
		div = document.getElementsByClassName("jspsych-display-element")[0];
        ...
        if (trial.require_movement) {
            div.querySelector('#jspsych-canvas-slider-response-response').addEventListener('click', function () {
				div.querySelector('#jspsych-canvas-slider-response-next').disabled = false;
        ...
        // div.querySelector('#jspsych-canvas-slider-response-next').addEventListener('click', function () {
        //     // measure response time
        //     var endTime = performance.now();
        //     response.rt = endTime - startTime;
        //     response.response = div.querySelector('#jspsych-canvas-slider-response-response').valueAsNumber;

        //     if (trial.response_ends_trial) {
        //         end_trial();
        //     } else {
        //         div.querySelector('#jspsych-canvas-slider-response-next').disabled = true;
        //     }

        // });
		// var para = document.createElement("div");
		// para.insertAdjacentHTML("beforebegin", html);
		// display_element.appendChild(para);
		...
		function draw() {
		    ...
		    if(fixationCross === true){
    			...
    			//ctx.moveTo(canvasWidth+200, canvasHeight+200);
		    	//ctx.lineTo(canvasWidth/2, canvasHeight/2 + fixationCrossHeight);
    			ctx.rect(canvasWidth/2-100, canvasHeight/2-200, fixationCrossWidth, fixationCrossHeight);
    			ctx.stroke();
	     ...
	     ////////////////////////////////// CANVAS SLIDER PLUGIN START /////////////////////////


		////////////////////////////////// CANVAS SLIDER PLUGIN END /////////////////////////
		}//End of draw
